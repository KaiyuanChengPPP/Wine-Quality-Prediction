...
def get_slope_2():
        ...
        slope4 = float(decimal.Decimal(random.randrange(-30, 30)) / 100)
        slope5 = float(decimal.Decimal(random.randrange(-30, 30)) / 100)
...
def teo_function(x):
    return -3.024277159982824 + 10.796585539348076 * x -1.6193107002624714 * x ** 2  -3.3530897630250576 * x ** 3 + \
           0.7356054885203648* x**4 -0.12875424759162615*x**5
...
def main():
    ...
    plt.title('sythetic data 1 polynomial 5')
    plt.show()
